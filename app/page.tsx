        ...
        <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/signup">
                <Button size="md" className="bg-marigold-500 text-ink hover:bg-marigold-600">
                  {t("landing.signup")}
                </Button>
              </Link>
              <Link href="/login">
      ...
      <section id="roles" className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {roles.map((r) => (
            <div
              key={r.title}
              className="rounded-lg border border-line bg-white p-5 transition-colors hover:border-teal-500"
            >
